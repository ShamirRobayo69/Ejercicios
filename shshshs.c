...
void main()
{
	...
	int nume=0,lim=0,tabla=0,op,cont=0,num=0,nest=0,nnotas=0;
	do
	{
		...
		switch(op)
		{
			...
			break;
			case 6:
				printf("Ingresar el numero de estudiantes:");
				scanf("%d",&nest);
				printf("Ingresar el numero de notas:");
				scanf("%d",&nnotas);
